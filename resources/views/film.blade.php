      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col col-12 col-sm-auto mb-3 mb-sm-0">
            ...
            <a href="{{ $film->photo->resize(1000, null)->path }}" class="img-zoom" data-fancybox data-caption="{{ $film->title() }})">
              <img src="{{ $film->photo->resize(300, null)->path }}" alt="{{ $film->title() }}" class="film-caver img-fluid">
            </a>
